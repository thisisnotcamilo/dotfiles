...
hi StatusLine	cterm=none ctermbg=NONE							gui=bold guibg=grey20
...
hi LineNr		ctermfg=32 ctermbg=NONE							guifg=steelblue guibg=grey20
hi MoreMsg		ctermfg=82										gui=bold guifg=#60ff60
hi NonText		ctermfg=black ctermbg=NONE   					gui=bold guifg=lightblue guibg=grey10
...
hi CursorColumn ctermbg=000										guibg=grey30
hi CursorLine	cterm=none ctermbg=NONE							guibg=grey30
hi CursorLineNr	ctermbg=NONE									guibg=grey30
hi Comment		cterm=bold ctermfg=63							guifg=#80a0ff
hi TabLineSel	cterm=reverse									gui=reverse
hi Type			ctermfg=82										guifg=#60ff60

hi MatchParen	ctermbg=darkgrey           								guifg=grey20

hi Ignore		ctermfg=darkgrey								guifg=grey20
" Groups for syntax highlighting
hi Constant		ctermfg=217 ctermbg=000							guifg=#ffa0a0 guibg=grey5
